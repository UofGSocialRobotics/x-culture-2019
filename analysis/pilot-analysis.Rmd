...
grid.arrange(all_western_correlational_data.w,
             all_western_correlational_data.e)

corr_list <- c(all_western_correlational_data.w)
ggsave("question_correlations.png")
```
...
Q: how much did individual interpretations differ between cultures? 