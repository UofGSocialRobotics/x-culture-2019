...
create_bucketed_bar_chart <- function(dat, gest) {
  ...
  p <- ggplot(d,aes(x=condition,y=bucket_percent,fill=factor(culture_bucket)))+
    ...
    scale_fill_manual("legend", values=c("eastern_ahigh" = "rosybrown2",  # rosybrown1, 3, 4
                                         "eastern_bmedium" = "sandybrown",
                                         "eastern_clow" = "lightgoldenrod2",
                                         "western_ahigh" = "mediumseagreen", # steelblue1, 3, 4
                                         "western_bmedium" = "steelblue",
                                         "western_clow" = "mediumpurple3")) +
