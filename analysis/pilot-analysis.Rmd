...
ggsave("wg1-0.png", plot=wg1_violin_culture_comparisons$c0_volin_comparison)
knitr::include_graphics("wg1-0.png")
kable(wg1_total_cultural_comparison_tables$c1_comparison)
ggsave("wg1-1.png", plot=wg1_violin_culture_comparisons$c1_violin_comparison)
knitr::include_graphics("wg1-1.png")
kable(wg1_total_cultural_comparison_tables$c2_compariso)
ggsave("wg1-2.png", plot=wg1_violin_culture_comparisons$c2_violin_comparison)
knitr::include_graphics("wg1-2.png")
```

### WG2
```{r, out.width='50%'}
kable(wg2_total_cultural_comparison_tables$c0_comparison)
ggsave("wg2-0.png", plot=wg2_violin_culture_comparisons$c0_violin_comparison)
knitr::include_graphics("wg2-0.png")
kable(wg2_total_cultural_comparison_tables$c1_comparison)
ggsave("wg2-1.png", plot=wg2_violin_culture_comparisons$c1_violin_comparison)
knitr::include_graphics("wg2-1.png")
kable(wg2_total_cultural_comparison_tables$c2_comparison)
ggsave("wg2-2.png", plot=wg2_violin_culture_comparisons$c2_violin_comparison)
knitr::include_graphics("wg2-2.png")
```

### WG3
```{r, out.width='50%'}
kable(wg3_total_cultural_comparison_tables$c0_comparison)
ggsave("wg3-0.png", plot=wg3_violin_culture_comparisons$c0_violin_comparison)
knitr::include_graphics("wg3-0.png")
kable(wg3_total_cultural_comparison_tables$c1_comparison)
ggsave("wg3-1.png", plot=wg3_violin_culture_comparisons$c1_violin_comparison)
knitr::include_graphics("wg3-1.png")
kable(wg3_total_cultural_comparison_tables$c2_comparison)
ggsave("wg3-2.png", plot=wg3_violin_culture_comparisons$c2_violin_comparison)
knitr::include_graphics("wg3-2.png")
```

### WG4
```{r, out.width='50%'}
kable(wg4_total_cultural_comparison_tables$c0_comparison)
ggsave("wg4-0.png", plot=wg4_violin_culture_comparisons$c0_violin_comparison)
knitr::include_graphics("wg4-0.png")
kable(wg4_total_cultural_comparison_tables$c1_comparison)
ggsave("wg4-1.png", plot=wg4_violin_culture_comparisons$c1_violin_comparison)
knitr::include_graphics("wg4-1.png")
kable(wg4_total_cultural_comparison_tables$c2_comparison)
ggsave("wg4-2.png", plot=wg4_violin_culture_comparisons$c2_violin_comparison)
knitr::include_graphics("wg4-2.png")
```

### WG5
```{r, out.width='50%'}
kable(wg5_total_cultural_comparison_tables$c0_comparison)
ggsave("wg5-0.png", plot=wg5_violin_culture_comparisons$c0_violin_comparison)
knitr::include_graphics("wg5-0.png")
kable(wg5_total_cultural_comparison_tables$c1_comparison)
ggsave("wg5-1.png", plot=wg5_violin_culture_comparisons$c1_violin_comparison)
knitr::include_graphics("wg5-1.png")
kable(wg5_total_cultural_comparison_tables$c2_comparison)
ggsave("wg5-2.png", plot=wg5_violin_culture_comparisons$c2_violin_comparison)
knitr::include_graphics("wg5-2.png")
```
...
ggsave("eg1-0.png", plot=eg1_violin_culture_comparisons$c0_violin_comparison)
knitr::include_graphics("eg1-0.png")
kable(eg1_total_cultural_comparison_tables$c1_comparison)
ggsave("eg1-1.png", plot=eg1_violin_culture_comparisons$c1_violin_comparison)
knitr::include_graphics("eg1-1.png")
kable(eg1_total_cultural_comparison_tables$c2_comparison)
ggsave("eg1-2.png", plot=eg1_violin_culture_comparisons$c2_violin_comparison)
knitr::include_graphics("eg1-2.png")
```

### EG2
```{r, out.width='50%'}
kable(eg2_total_cultural_comparison_tables$c0_comparison)
ggsave("eg2-0.png", plot=eg2_violin_culture_comparisons$c0_violin_comparison)
knitr::include_graphics("eg2-0.png")
kable(eg2_total_cultural_comparison_tables$c1_comparison)
ggsave("eg2-1.png", plot=eg2_violin_culture_comparisons$c1_violin_comparison)
knitr::include_graphics("eg2-1.png")
kable(eg2_total_cultural_comparison_tables$c2_comparison)
ggsave("eg2-2.png", plot=eg2_violin_culture_comparisons$c2_violin_comparison)
knitr::include_graphics("eg2-2.png")
```

### EG3
```{r, out.width='50%'}
kable(eg3_total_cultural_comparison_tables$c0_comparison)
ggsave("eg3-0.png", plot=eg3_violin_culture_comparisons$c0_violin_comparison)
knitr::include_graphics("eg3-0.png")
kable(eg3_total_cultural_comparison_tables$c1_comparison)
ggsave("eg3-1.png", plot=eg3_violin_culture_comparisons$c1_violin_comparison)
knitr::include_graphics("eg3-1.png")
kable(eg3_total_cultural_comparison_tables$c2_comparison)
ggsave("eg3-2.png", plot=eg3_violin_culture_comparisons$c2_violin_comparison)
...
ggsave("eg4-0.png", plot=eg4_violin_culture_comparisons$c0_violin_comparison)
knitr::include_graphics("eg4-0.png")
kable(eg4_total_cultural_comparison_tables$c1_comparison)
ggsave("eg4-1.png", plot=eg4_violin_culture_comparisons$c1_violin_comparison)
knitr::include_graphics("eg4-1.png")
kable(eg4_total_cultural_comparison_tables$c2_comparison)
ggsave("eg4-2.png", plot=eg4_violin_culture_comparisons$c2_violin_comparison)
knitr::include_graphics("eg4-2.png")
```
...
bucket_culture_scores <- function(dat) {
  d <- dat %>%
    mutate(score_bucket = ifelse(score >= 5, "high", ifelse(score <= 2, "low", "medium")))
  return(d)
}


create_bucketed_bar_chart <- function(dat, g, gest) {
  d <- bucket_culture_scores(dat) %>%
    filter(group==g) %>%
    group_by(viewer_culture, condition) %>%
    mutate(count_bucket = ifelse(score_bucket=="high", sum(score_bucket=="high"), 
                          ifelse(score_bucket=="medium", sum(score_bucket=="medium"), 
                                 sum(score_bucket=="low")))) %>%
    group_by(viewer_culture, condition) %>%
    mutate(bucket_percent = count_bucket / sum(unique(count_bucket)))
  
  ggplot(d,aes(x=condition,y=bucket_percent,fill=factor(viewer_culture)))+
    geom_bar(stat="identity",position="dodge")+
    xlab("Gesture Condition")+ylab("Score")+
    ggtitle(paste("Score for", g, "for", gest, sep=" "))  
}

g <- "unity"
gest <- "WG1"
wg1_total_bucketed <- bucket_culture_scores(wg1_total) %>%
  filter(group==g) %>%
  group_by(viewer_culture, condition) %>%
  mutate(count_bucket = ifelse(score_bucket=="high", sum(score_bucket=="high"), 
                        ifelse(score_bucket=="medium", sum(score_bucket=="medium"), 
...
ggplot(wg1_total_bucketed,aes(x=condition,y=bucket_percent,fill=factor(culture_bucket)))+
  geom_bar(stat="identity",position="dodge")+
  xlab("Gesture Condition")+ylab("Score")+
  ggtitle(paste("Score for", g, "for", gest, sep=" "))

wg1_comp <- create_bucketed_bar_chart(wg1_total, "unity", "WG1")

wg2_total_bucketed <- bucket_culture_scores(wg2_total)
wg3_total_bucketed <- bucket_culture_scores(wg3_total)
wg4_total_bucketed <- bucket_culture_scores(wg4_total)
wg5_total_bucketed <- bucket_culture_scores(wg5_total)

eg1_total_bucketed <- bucket_culture_scores(eg1_total)
eg2_total_bucketed <- bucket_culture_scores(eg2_total)
eg3_total_bucketed <- bucket_culture_scores(eg3_total)
eg4_total_bucketed <- bucket_culture_scores(eg4_total)
```

See some charts for kicks
```{r}
