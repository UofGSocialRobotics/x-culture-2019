...
# Create grouped overlay of correlated questions. Violin plot of question correlations by group (for single conditions of a single gesture). This turns out to not be the best or even most honest visualization, as the data is not actually continuous. 
...
get_all_density_graphs <- function(d0, d1, d2, n0 = "original", n1 = "cond1", n2 = "cond2", gesture = "N/A") {
...
# can do all of this with eastern gestures as well. 
all_wg1_data.w <- get_all_density_graphs(wg1.0.w, wg1.1.w, wg1.2.w)
all_wg2_data.w <- get_all_density_graphs(wg2.0.w, wg2.1.w, wg2.2.w)
all_wg3_data.w <- get_all_density_graphs(wg3.0.w, wg3.1.w, wg3.2.w)
all_wg4_data.w <- get_all_density_graphs(wg4.0.w, wg4.1.w, wg4.2.w)
all_wg5_data.w <- get_all_density_graphs(wg5.0.w, wg5.1.w, wg5.2.w)

all_wg1_data.e <- get_all_density_graphs(wg1.0.e, wg1.1.e, wg1.2.e)
all_wg2_data.e <- get_all_density_graphs(wg2.0.e, wg2.1.e, wg2.2.e)
all_wg3_data.e <- get_all_density_graphs(wg3.0.e, wg3.1.e, wg3.2.e)
all_wg4_data.e <- get_all_density_graphs(wg4.0.e, wg4.1.e, wg4.2.e)
all_wg5_data.e <- get_all_density_graphs(wg5.0.e, wg5.1.e, wg5.2.e)
```

Now we can access all of the cultural-independent responses through the variables from above:
...
`all_dat$violin_density_grouped_overlay`: the violin plot of all group distributions across gesture conditions, but overlayed.
`all_dat$violin_density_grouped`: the violin plot of group distributions across gesture conditions.
`all_dat$density_grouped`: density plot of group distributions (density of responses for likert category) across gesture conditions.
`all_dat$density_question`: density plot of all question distributions (density of responses for likert category) across gesture conditions.
...
```
And the result is a correlation matrix of the questions for the different groups of participants. 
...
wg4.w.correlations <- plot_diff_matrix_pretty(rbind(create_difference_matrix(wg4.0.w), 
                                                    create_difference_matrix(wg4.1.w), 
                                                    create_difference_matrix(wg4.2.w)))

wg4.e.coorelations <- plot_diff_matrix_pretty(rbind(create_difference_matrix(wg4.0.e), 
                                                    create_difference_matrix(wg4.1.e), 
                                                    create_difference_matrix(wg4.2.e)))
grid.arrange(wg4.w.correlations,
             wg4.e.coorelations)
```

And finally, see all of them together with 
```{r total_correlational_data}
all_correlational_data.we
```
...
clean_data <- function(d0, d1, d2, n0="original", n1="cond1", n2="cond2") {
...
do_t_test_adjusted <- function(cond1, cond2, statement, dat) {
  d <- data.frame()
  if(dat == "1") {
    d <- clean_data(wg1.0.w, wg1.1.w, wg1.2.w)
  }
  if(dat == "2") {
    d <- clean_data(wg2.0.w, wg2.1.w, wg2.2.w)
  }
  if(dat == "3") {
    d <- clean_data(wg3.0.w, wg3.1.w, wg3.2.w)
  }
  if(dat == "4") {
    d <- clean_data(wg4.0.w, wg4.1.w, wg4.2.w)
    }
  if(dat == "5") {
    d <- clean_data(wg5.0.w, wg5.1.w, wg5.2.w)
  }
...
make_individual_pie_comparisons <- function(dat, g1, g2, c1, c2) {
  p <- make_pie_chart(get_pie_data(dat, g1, g2), "likert", paste(g1, g2, sep="/"), c1, c2)
}

p_wg1.0.w <- make_individual_pie_comparisons(wg1.0.w, "conflict", "unity", "unpolite", "original")
p_wg1.1.w <- make_individual_pie_comparisons(wg1.1.w, "conflict", "unity", "unpolite", "intertwine")
p_wg1.2.w <- make_individual_pie_comparisons(wg1.2.w, "conflict", "unity", "unpolite", "collide")

p_wg1.0.e <- make_individual_pie_comparisons(wg1.0.e, "conflict", "unity", "unpolite", "original")
p_wg1.1.e <- make_individual_pie_comparisons(wg1.1.e, "conflict", "unity", "unpolite", "intertwine")
p_wg1.2.e <- make_individual_pie_comparisons(wg1.2.e, "conflict", "unity", "unpolite", "collide")
```

For example, we can visualize the difference between how individuals in western culture rated different response domains comapred to eastern cultures as below: 
#### Comparing cultures 
```{r}
grid.arrange(p_wg1.0.w, p_wg1.0.e, 
             ...
             ncol=2)
```
Notice how the amount rating "both" and "neither" changes significantly between the cultures. This indicates that the different cultures pick up different semantic cues from the gesture. 
...
```{r}
wrangle_culture_groups <- function(d, cond="data", culture="western") {
  gathered <- gather_select(d)
  grouped <- add_groups(gathered)
...
create_total_bicultural_tables <- function(wd0, wd1, wd2, ed0, ed1, ed2, cond1="cond1", cond2="cond2") {
  d0_w <- wrangle_culture_groups(wd0, "original", "western")
  d1_w <- wrangle_culture_groups(wd1, cond1, "western")
  d2_w <- wrangle_culture_groups(wd2, cond2, "western")
  d0_e <- wrangle_culture_groups(ed0, "original", "eastern")
  d1_e <- wrangle_culture_groups(ed1, cond1, "eastern")
  d2_e <- wrangle_culture_groups(ed2, cond2, "eastern")
...
create_bucketed_bar_chart <- function(dat, gest) {
  ...
  p <- ggplot(d,aes(x=condition,y=bucket_percent,fill=factor(culture_bucket)))+
    ...
    scale_fill_manual("Viewer Culture Score Bucket", 
                      labels=c("Eastern High", "Western High", "Eastern Medium", "Western Medium", "Eastern Low", "Western Low"),
...
A: Look instead of "low," and "high," the union of the two -- those who had interpretation. 
```{r strong_interpretation_buckets}
get_strong_interpretation_graphs <- function(dat, gest) {
  d <- dat %>%
...
weak.strong.interp <- get_strong_interpretation_graphs(wg1_summary_stats, "WG1")
weak.strong.interp
```
...
## see if difference is sig diff from uniform
w_viewer_sum <- all_w_dat %>%
    summarise('1'=sum(score==1), '2'=sum(score==2), '3'=sum(score==3), 
              '4'=sum(score==4), '5'=sum(score==5), '6'=sum(score==6), '7'=sum(score==7))
e_viewer_sum <- all_e_dat %>%
    summarise('1'=sum(score==1), '2'=sum(score==2), '3'=sum(score==3), 
              '4'=sum(score==4), '5'=sum(score==5), '6'=sum(score==6), '7'=sum(score==7))
total_diff_raw_scores = data.frame('1'=w_viewer_sum$`1` - e_viewer_sum$`1`, 
                                   '2'=w_viewer_sum$`2` - e_viewer_sum$`2`, 
                                   '3'=w_viewer_sum$`3` - e_viewer_sum$`3`, 
                                   '4'=w_viewer_sum$`4` - e_viewer_sum$`4`, 
                                   '5'=w_viewer_sum$`5` - e_viewer_sum$`5`, 
                                   '6'=w_viewer_sum$`6` - e_viewer_sum$`6`, 
                                   '7'=w_viewer_sum$`7` - e_viewer_sum$`7`)
# theoretically we have 401 in each category, bc 2808 fewer participants for eastern. 
tdrw <- c(204, 540, 375, 499, 449, 330, 411)
ks.test(tdrw, "punif", 360, 440)
...
I just wanna see these things side by side now
```{r}
knitr::include_graphics("../gesture_imgs/wg1-0.png")
knitr::include_graphics("../gesture_imgs/wg1-1.png")
knitr::include_graphics("../gesture_imgs/wg1-2.png")
knitr::include_graphics("wg1-barcomp.png")
kable(get_all_within_culture_diffs2(wg1_total, "wg1"))

knitr::include_graphics("../gesture_imgs/wg2-0.png")
knitr::include_graphics("../gesture_imgs/wg2-1.png")
knitr::include_graphics("../gesture_imgs/wg2-2.png")
knitr::include_graphics("wg2-barcomp.png")
kable(get_all_within_culture_diffs2(wg2_total, "wg2"))

knitr::include_graphics("../gesture_imgs/wg3-0.png")
knitr::include_graphics("../gesture_imgs/wg3-1.png")
knitr::include_graphics("../gesture_imgs/wg3-2.png")
knitr::include_graphics("wg3-barcomp.png")
kable(get_all_within_culture_diffs2(wg3_total, "wg3"))

knitr::include_graphics("../gesture_imgs/wg4-0.png")
knitr::include_graphics("../gesture_imgs/wg4-1.png")
knitr::include_graphics("../gesture_imgs/wg4-2.png")
knitr::include_graphics("wg4-barcomp.png")
kable(get_all_within_culture_diffs2(wg4_total, "wg4"))

knitr::include_graphics("../gesture_imgs/wg5-0.png")
knitr::include_graphics("../gesture_imgs/wg5-1.png")
knitr::include_graphics("../gesture_imgs/wg5-2.png")
knitr::include_graphics("wg5-barcomp.png")
kable(get_all_within_culture_diffs2(wg5_total, "wg5"))

knitr::include_graphics("../gesture_imgs/eg1-0.png")
knitr::include_graphics("../gesture_imgs/eg1-1.png")
knitr::include_graphics("../gesture_imgs/eg1-2.png")
knitr::include_graphics("eg1-barcomp.png")
kable(get_all_within_culture_diffs2(eg1_total, "eg1"))

knitr::include_graphics("../gesture_imgs/eg2-0.png")
knitr::include_graphics("../gesture_imgs/eg2-1.png")
knitr::include_graphics("../gesture_imgs/eg2-2.png")
knitr::include_graphics("eg2-barcomp.png")
kable(get_all_within_culture_diffs2(eg2_total, "eg2"))

knitr::include_graphics("../gesture_imgs/eg3-0.png")
knitr::include_graphics("../gesture_imgs/eg3-1.png")
knitr::include_graphics("../gesture_imgs/eg3-2.png")
knitr::include_graphics("eg3-barcomp.png")
kable(get_all_within_culture_diffs2(eg3_total, "eg3"))

knitr::include_graphics("../gesture_imgs/eg4-0.png")
knitr::include_graphics("../gesture_imgs/eg4-1.png")
knitr::include_graphics("../gesture_imgs/eg4-2.png")
knitr::include_graphics("eg4-barcomp.png")
kable(get_all_within_culture_diffs2(eg4_total, "eg4"))
