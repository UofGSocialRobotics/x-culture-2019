...
unp_all <- rbind(gather_clean(u0, "original"), 
                 gather_clean(u1, "cond1"), 
                 gather_clean(u2, "cond2"))
...
do_anova_per_question <- function(data, measure) {
  question_data <- data %>%
    filter(metaphor_measure==measure)
  res.aov <- aov(score ~ condition, data=question_data)
  print(measure)
  print(summary(res.aov))
  return(res.aov)
}
...
do_anova_per_data <- function(data) {
  # opts <- c("Answer.accessible", "Answer.open", 
  #                 "Answer.confident", "Answer.sure",
  #                 "Answer.control", "Answer.dominant", 
  #                 "Answer.goal", "Answer.worktogether",
  #                 "Answer.conflict", "Answer.tension")
  ...
  # for (o in opts) {
  #   print(o)
  #   a <- do_anova_per_question(data, o)
  #   print(summary(a))
  #   print("========================")
  # }
  print("==== BY GROUP ====")
