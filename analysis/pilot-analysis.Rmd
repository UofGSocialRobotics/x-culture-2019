...
all_eastern_correlational_data.w <- plot_diff_matrix_pretty(rbind(create_difference_matrix(eg1.0.w), 
                                                        ...
                                                        create_difference_matrix(eg5.0.w), 
                                                        create_difference_matrix(eg5.1.w),
                                                        create_difference_matrix(eg5.2.w),
...
all_eastern_correlational_data.e <- plot_diff_matrix_pretty(rbind(create_difference_matrix(eg1.0.e), 
                                                        ...
                                                        create_difference_matrix(eg5.0.e), 
                                                        create_difference_matrix(eg5.1.e),
                                                        create_difference_matrix(eg5.2.e),
