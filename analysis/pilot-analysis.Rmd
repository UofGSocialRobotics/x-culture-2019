...
make_pie_chart <- function(dat, group1, group2, gesture_name, cond) {
  #d <- get_pie_data(dat, "conflict", "unity")  
...
p_wg1.0.w <- make_pie_chart(get_pie_data(wg1.0.w, "conflict", "unity"), "likert", "conflict/unity", "unpolite", "original")
p_wg1.1.w <- make_pie_chart(get_pie_data(wg1.1.w, "conflict", "unity"), "likert", "conflict/unity", "unpolite", "intertwine")
p_wg1.2.w <- make_pie_chart(get_pie_data(wg1.2.w, "conflict", "unity"), "likert", "conflict/unity", "unpolite", "collide")
p_wg2.0.w <- make_pie_chart(get_pie_data(wg2.0.w, "control", "openness"), "likert", "control/openness", "entity", "original")
p_wg2.1.w <- make_pie_chart(get_pie_data(wg2.1.w, "control", "openness"), "likert", "control/openness", "entity", "open")
p_wg2.2.w <- make_pie_chart(get_pie_data(wg2.2.w, "control", "openness"), "likert", "control/openness", "entity", "chest")
p_wg3.0.w <- make_pie_chart(get_pie_data(wg3.0.w, "openness", "unity"), "likert", "openness/unity", "audience", "original")
p_wg3.1.w <- make_pie_chart(get_pie_data(wg3.1.w, "openness", "unity"), "likert", "openness/unity", "audience", "down")
p_wg3.2.w <- make_pie_chart(get_pie_data(wg3.2.w, "openness", "unity"), "likert", "openness/unity", "audience", "open")
p_wg4.0.w <- make_pie_chart(get_pie_data(wg4.0.w, "size", "control"), "likert", "size/control", "anything", "original")
p_wg4.1.w <- make_pie_chart(get_pie_data(wg4.1.w, "size", "control"), "likert", "size/control", "anything", "frame")
p_wg4.2.w <- make_pie_chart(get_pie_data(wg4.2.w, "size", "control"), "likert", "size/control", "anything", "surface")
p_wg5.0.w <- make_pie_chart(get_pie_data(wg5.0.w, "certainty", "unity"), "likert", "certainty/unity", "specific", "original")
p_wg5.1.w <- make_pie_chart(get_pie_data(wg5.1.w, "certainty", "unity"), "likert", "certainty/unity", "specific", "bowl")
p_wg5.2.w <- make_pie_chart(get_pie_data(wg5.2.w, "certainty", "unity"), "likert", "certainty/unity", "specific", "forward")

p_wg1.0.e <- make_pie_chart(get_pie_data(wg1.0.e, "conflict", "unity"), "likert", "conflict/unity", "unpolite", "original")
p_wg1.1.e <- make_pie_chart(get_pie_data(wg1.1.e, "conflict", "unity"), "likert", "conflict/unity", "unpolite", "intertwine")
p_wg1.2.e <- make_pie_chart(get_pie_data(wg1.2.e, "conflict", "unity"), "likert", "conflict/unity", "unpolite", "collide")

```

```{r}
all_wg1_data$violin_density_grouped_overlay
grid.arrange(p_wg1.0.w, p_wg1.1.w, p_wg1.2.w, ncol=1)
...
violin_prep_data_get_plot <- function(data, cond="original", gesture_name="unknown") {
  d <- filter(data, condition == cond)
  g <- violin_compare_cultures_across_meta_groups(d, cond, gesture_name)
  return(g)
}
...
get_violin_comparisons_per_gesture <- function(dat, cond1="cond1", cond2="cond2", gesture_name="unknown") {
  ...
  c1 <- violin_prep_data_get_plot(dat, cond1, gesture_name)
  c2 <- violin_prep_data_get_plot(dat, cond2, gesture_name)
...
```{r}
## playing with dotplots
dot_compare_cultures_across_meta_groups <- function(data, cond="original", gesture_name="unknown") {
  g <- ggplot(filter(data, condition == cond)) + 
    aes(x=factor(nrow(data)), binaxis = "x",y=score,fill=viewer_culture) +
    geom_dotplot(alpha=0.5,position="identity") +
    facet_wrap("group") +
    labs(
      title = paste("Comparison across cultures for", gesture_name, " -- ", cond, "Condition")
    ) 
...
dot_prep_data_get_plot <- function(data, cond="original", gesture_name="unknown") {
  d <- filter(data, condition == cond)
  g <- dot_compare_cultures_across_meta_groups(d, cond, gesture_name)
  return(g)
}


get_dot_comparisons_per_gesture <- function(dat, cond1="cond1", cond2="cond2", gesture_name="unknown") {
  c0 <- dot_prep_data_get_plot(dat, "original", gesture_name)
  return(c0)
}

get_dot_comparisons_per_gesture(wg1_total, "cond1", "cond2", "wg1")

t_dat <- wg1_total %>%
  filter(condition=="original") 
  
ggplot(t_dat) + 
  geom_dotplot(binaxis="y", method="dotdensity", stackdir = "center", binwidth=0.3) +
  aes(x=score, fill=viewer_culture, alpha=1) +
  facet_wrap("group") +
  labs(
    title = paste("testing this bad larry")
  ) 
...
wg1_violin_culture_comparisons$c0_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg1-0.png")
kable(wg1_total_cultural_comparison_tables$c1_comparison)
wg1_violin_culture_comparisons$c1_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg1-1.png")
kable(wg1_total_cultural_comparison_tables$c2_comparison)
wg1_violin_culture_comparisons$c2_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg1-2.png")
```

### WG2
```{r, out.width='50%'}
kable(wg2_total_cultural_comparison_tables$c0_comparison)
wg2_violin_culture_comparisons$c0_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg2-0.png")
kable(wg2_total_cultural_comparison_tables$c1_comparison)
wg2_violin_culture_comparisons$c1_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg2-1.png")
kable(wg2_total_cultural_comparison_tables$c2_comparison)
wg2_violin_culture_comparisons$c2_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg2-2.png")
```

### WG3
```{r, out.width='50%'}
kable(wg3_total_cultural_comparison_tables$c0_comparison)
wg3_violin_culture_comparisons$c0_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg3-0.png")
kable(wg3_total_cultural_comparison_tables$c1_comparison)
wg3_violin_culture_comparisons$c1_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg3-1.png")
kable(wg3_total_cultural_comparison_tables$c2_comparison)
wg3_violin_culture_comparisons$c2_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg3-2.png")
```

### WG4
```{r, out.width='50%'}
kable(wg4_total_cultural_comparison_tables$c0_comparison)
wg4_violin_culture_comparisons$c0_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg4-0.png")
kable(wg4_total_cultural_comparison_tables$c1_comparison)
wg4_violin_culture_comparisons$c1_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg4-1.png")
kable(wg4_total_cultural_comparison_tables$c2_comparison)
wg4_violin_culture_comparisons$c2_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg4-2.png")
```

### WG5
```{r, out.width='50%'}
kable(wg5_total_cultural_comparison_tables$c0_comparison)
wg5_violin_culture_comparisons$c0_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg5-0.png")
kable(wg5_total_cultural_comparison_tables$c1_comparison)
wg5_violin_culture_comparisons$c1_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg5-1.png")
kable(wg5_total_cultural_comparison_tables$c2_comparison)
wg5_violin_culture_comparisons$c2_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/wg5-2.png")
```
...
eg1_violin_culture_comparisons$c0_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/eg1-0.png")
kable(eg1_total_cultural_comparison_tables$c1_comparison)
eg1_violin_culture_comparisons$c1_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/eg1-1.png")
kable(eg1_total_cultural_comparison_tables$c2_comparison)
eg1_violin_culture_comparisons$c2_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/eg1-2.png")
```

### EG2
```{r, out.width='50%'}
kable(eg2_total_cultural_comparison_tables$c0_comparison)
eg2_violin_culture_comparisons$c0_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/eg2-0.png")
kable(eg2_total_cultural_comparison_tables$c1_comparison)
eg2_violin_culture_comparisons$c1_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/eg2-1.png")
kable(eg2_total_cultural_comparison_tables$c2_comparison)
eg2_violin_culture_comparisons$c2_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/eg2-2.png")
```

### EG3
```{r, out.width='50%'}
kable(eg3_total_cultural_comparison_tables$c0_comparison)
eg3_violin_culture_comparisons$c0_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/eg3-0.png")
kable(eg3_total_cultural_comparison_tables$c1_comparison)
eg3_violin_culture_comparisons$c1_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/eg3-1.png")
kable(eg3_total_cultural_comparison_tables$c2_comparison)
eg3_violin_culture_comparisons$c2_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/eg3-2.png")
```

### EG4
```{r, out.width='50%'}
kable(eg4_total_cultural_comparison_tables$c0_comparison)
eg4_violin_culture_comparisons$c0_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/eg4-0.png")
kable(eg4_total_cultural_comparison_tables$c1_comparison)
eg4_violin_culture_comparisons$c1_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/eg4-1.png")
kable(eg4_total_cultural_comparison_tables$c2_comparison)
eg4_violin_culture_comparisons$c2_violin_comparison
knitr::include_graphics("/Users/carolynsaund/Desktop/eg4-2.png")
```
...
wg1_bucket_scores <- wg1_total %>% 
    mutate(score_bucket = ifelse(score %in% 5:7, "high", 
                          ifelse(score %in% 3:4, "med",
                          ifelse(score %in% 1:2, "low", "NA"))))
...
## my god this is so quick and dirty I am deeply ashamed.

t <- filter(wg1_bucket_scores, viewer_culture=="western", condition=="original", group=="conflict")

a <- sum(t$score_bucket == "high") / nrow(t) 
b <- sum(t$score_bucket == "med") / nrow(t)
c <- sum(t$score_bucket == "low") / nrow(t)
...
ggplot(df, aes(x="", y=value, fill=bucket))+
    geom_bar(width = 1, stat = "identity") + 
    coord_polar("y", start=0)+  blank_theme +
    theme(axis.text.x=element_blank()) +
    geom_text(aes(label = paste0(round(value*100), "%")), position = position_stack(vjust = 0.5)) 
