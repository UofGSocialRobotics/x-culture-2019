...
Fucks sake I just need to do an anova on the scores by condition. 



I have a crazy idea about correlation matrices
          Western
eastern   c0  c1  c2
        c0
        c1
        c2
dat needs to look like
culture condition   group p
...
Try it with a violin plot
```{r}
ggplot(wg1_total, aes(viewer_culture, score)) + 
  geom_violin(aes(fill=condition, alpha=0.3), position="identity") +
  facet_wrap(~group)
```

my god it looks horrible, nevermind. 