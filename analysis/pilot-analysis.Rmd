...
do_the_thing <- function(d0, d1, d2) {
  ...
  ## violin density plot 
 violin_density <- plot_violin_density(da_named, db_named, dc_named) 
 
 ## plot density plot -- with groups
 grouped_density <- plot_group_density(d0_grouped_named, d1_grouped_named, d2_grouped_named)
 
 return_list <- list("overlays" = overlays, "correlation_matrix" = difference_matrix, "violin" = violin_density, "density" = grouped_density)
}
...
all_dat$violin: the violin plot of all question distributions across gesture conditions.
all_dat$density: density plot of group distributions across gesture conditions.
