...
#### Comparing cultures 
```{r display_cultural_comparisons}
...
```{r cross_cultural_violin_comparisons}
...
### Stats
```{r bi_cultural_tests, echo = FALSE}
...
```{r save_everything, include=FALSE}
# Western
...
```{r check_conflict_interpretation}
...
kable(diff_counts)
```
A: So there is no particular category in which one culture was more apt to rate higher than the other. 
...
A: Yes, the western gestures, but there's no objective "correct" interpretation so who cares.
...
## TODO change this just to add higher 
#c <- diffs_only %>%
#  group_by(group) %>%
...
```{r}
get_within_culture_diffs_by_group <- function(dat, g){
  wg1.w.viewers <- dat %>%
    filter(viewer_culture=="western") 
  wg1.e.viewers <- dat %>%
    filter(viewer_culture=="eastern") 
...
get_all_within_culture_diffs <- function(dat, name) {
  cot <- get_within_culture_diffs_by_group(dat, "control")
  con <- get_within_culture_diffs_by_group(dat, "conflict")
  cer <- get_within_culture_diffs_by_group(dat, "certainty")
  opn <- get_within_culture_diffs_by_group(dat, "openness")
  siz <- get_within_culture_diffs_by_group(dat, "size")
  uni <- get_within_culture_diffs_by_group(dat, "unity")
  ret <- rbind(cer, con, cot, opn, siz, uni) %>%
    mutate("gesture_name" = name)
  return(ret)
}

compare_manipulations_between_cultures <- rbind( get_all_within_culture_diffs(wg1_total, "wg1"), 
                                                 get_all_within_culture_diffs(wg2_total, "wg2"), 
                                                 get_all_within_culture_diffs(wg3_total, "wg3"), 
                                                 get_all_within_culture_diffs(wg4_total, "wg4"), 
                                                 get_all_within_culture_diffs(wg5_total, "wg5"), 
                                                 get_all_within_culture_diffs(eg1_total, "eg1"), 
                                                 get_all_within_culture_diffs(eg2_total, "eg2"), 
                                                 get_all_within_culture_diffs(eg3_total, "eg3"), 
                                                 get_all_within_culture_diffs(eg4_total, "eg4"))
```
...
knitr::include_graphics("../gesture_imgs/wg1-2.png")
knitr::include_graphics("wg1-barcomp.png")
kable(get_all_within_culture_diffs(wg1_total, "wg1"))

knitr::include_graphics("../gesture_imgs/wg2-0.png")
knitr::include_graphics("../gesture_imgs/wg2-1.png")
knitr::include_graphics("../gesture_imgs/wg2-2.png")
knitr::include_graphics("wg2-barcomp.png")
kable(get_all_within_culture_diffs(wg2_total, "wg2"))

knitr::include_graphics("../gesture_imgs/wg3-0.png")
knitr::include_graphics("../gesture_imgs/wg3-1.png")
knitr::include_graphics("../gesture_imgs/wg3-2.png")
knitr::include_graphics("wg3-barcomp.png")
kable(get_all_within_culture_diffs(wg3_total, "wg3"))

knitr::include_graphics("../gesture_imgs/wg4-0.png")
knitr::include_graphics("../gesture_imgs/wg4-1.png")
knitr::include_graphics("../gesture_imgs/wg4-2.png")
knitr::include_graphics("wg4-barcomp.png")
kable(get_all_within_culture_diffs(wg4_total, "wg4"))

knitr::include_graphics("../gesture_imgs/wg5-0.png")
knitr::include_graphics("../gesture_imgs/wg5-1.png")
knitr::include_graphics("../gesture_imgs/wg5-2.png")
knitr::include_graphics("wg5-barcomp.png")
kable(get_all_within_culture_diffs(wg5_total, "wg5"))

knitr::include_graphics("../gesture_imgs/eg1-0.png")
knitr::include_graphics("../gesture_imgs/eg1-1.png")
knitr::include_graphics("../gesture_imgs/eg1-2.png")
knitr::include_graphics("eg1-barcomp.png")
kable(get_all_within_culture_diffs(eg1_total, "eg1"))

knitr::include_graphics("../gesture_imgs/eg2-0.png")
knitr::include_graphics("../gesture_imgs/eg2-1.png")
knitr::include_graphics("../gesture_imgs/eg2-2.png")
knitr::include_graphics("eg2-barcomp.png")
kable(get_all_within_culture_diffs(eg2_total, "eg2"))

knitr::include_graphics("../gesture_imgs/eg3-0.png")
knitr::include_graphics("../gesture_imgs/eg3-1.png")
knitr::include_graphics("../gesture_imgs/eg3-2.png")
knitr::include_graphics("eg3-barcomp.png")
kable(get_all_within_culture_diffs(eg3_total, "eg3"))

knitr::include_graphics("../gesture_imgs/eg4-0.png")
knitr::include_graphics("../gesture_imgs/eg4-1.png")
knitr::include_graphics("../gesture_imgs/eg4-2.png")
knitr::include_graphics("eg4-barcomp.png")
kable(get_all_within_culture_diffs(eg4_total, "eg4"))
```
A: We see that our manipulations led to changes in different areas all across the board. 