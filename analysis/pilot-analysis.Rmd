...
## I don't think this is a particularly useful metric. It basically tells us slightly less
## Than what we do below. It was necessary up above but not here. 
...
# wg2_total_comparison_tables <- do_t_culture_groups(wg2_total, "cond1", "cond2", "wg2")
# wg3_total_comparison_tables <- do_t_culture_groups(wg3_total, "cond1", "cond2", "wg3")
# wg4_total_comparison_tables <- do_t_culture_groups(wg4_total, "cond1", "cond2", "wg4")
# wg5_total_comparison_tables <- do_t_culture_groups(wg5_total, "cond1", "cond2", "wg5")
# 
# eg1_total_comparison_tables <- do_t_culture_groups(eg1_total, "cond1", "cond2", "eg1")
# eg2_total_comparison_tables <- do_t_culture_groups(eg2_total, "cond1", "cond2", "eg2")
# eg3_total_comparison_tables <- do_t_culture_groups(eg3_total, "cond1", "cond2", "eg3")
# eg4_total_comparison_tables <- do_t_culture_groups(eg4_total, "cond1", "cond2", "eg4")
# eg5_total_comparison_tables <- do_t_culture_groups(eg5_total, "cond1", "cond2", "eg5")
