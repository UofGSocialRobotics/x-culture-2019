...
get_strong_interpretation_graphs <- function(dat) {
  d <- dat %>%
...
wg1_strong_int_graph <- get_strong_interpretation_graphs(wg1_summary_stats)
wg2_strong_int_graph <- get_strong_interpretation_graphs(wg2_summary_stats)
wg3_strong_int_graph <- get_strong_interpretation_graphs(wg3_summary_stats)
wg4_strong_int_graph <- get_strong_interpretation_graphs(wg4_summary_stats)
wg5_strong_int_graph <- get_strong_interpretation_graphs(wg5_summary_stats)

eg1_strong_int_graph <- get_strong_interpretation_graphs(eg1_summary_stats)
eg2_strong_int_graph <- get_strong_interpretation_graphs(eg2_summary_stats)
eg3_strong_int_graph <- get_strong_interpretation_graphs(eg3_summary_stats)
eg4_strong_int_graph <- get_strong_interpretation_graphs(eg4_summary_stats)
